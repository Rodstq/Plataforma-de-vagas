...
<div class="d-flex flex-row justify-content-between">
    <h1> Vagas em destaque </h1>
        <ul class="d-flex flex-row">
            <li class="mx-2 btn btn-secondary btn-outline-dark"><a class="text-decoration-none text-light"href="/criar_vaga">Criar nova vaga</a></li>
        </ul>
</div>
    ...
    @foreach($vaga as $oport)
        <a class="text-light "href="{{ route('detalhes_vaga', ['id' => $oport->id]) }}">{{$oport->nome}}</a>
    @endforeach
    </div>
